...
#pragma config(Motor,  port7,           rightfront,    tmotorVex393TurboSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           leftback,      tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port9,           leftfront,     tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
