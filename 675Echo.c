...
#pragma config(Motor,  port7,           rightfront,    tmotorVex393TurboSpeed_MC29, openLoop, reversed, encoderPort, I2C_1)
...
#pragma config(Motor,  port10,          chain,         tmotorVex393HighSpeed_HBridge, openLoop, encoderPort, I2C_5)
