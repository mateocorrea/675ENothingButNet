...
#pragma config(Motor,  port2,           topLeftTrans,  tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port3,           botLeftTrans,  tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port4,           topRightTrans, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           botRightTrans, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           rightFlywheel, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           leftFlywheel,  tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_3)
