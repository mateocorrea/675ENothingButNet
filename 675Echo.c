...
#pragma config(Motor,  port1,           rightfront,    tmotorVex393_HBridge, openLoop, reversed, driveRight)
...
#pragma config(Motor,  port4,           topleftlauncher, tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port5,           bottomleftlauncher, tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           roller,        tmotorVex393HighSpeed_MC29, openLoop, driveLeft)
#pragma config(Motor,  port7,           chain,         tmotorVex393HighSpeed_MC29, openLoop, driveLeft)
...
#pragma config(Motor,  port10,          rightback,     tmotorVex393_HBridge, openLoop, reversed, driveRight)
