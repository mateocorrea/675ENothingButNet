...
float KpHighL = 0.0024;
float KiHighL = 0.0000009;//2200;
float KdHighL = 0.000002;//250;
float KpHighR = KpHighL;
float KiHighR = KiHighL;
float KdHighR = KdHighL;
float KpHighLS = 0.002850000;
float KiHighLS = 0.000001050;
float KdHighLS  = 0.000000050;
